...
public class DispatcherServlet extends HttpServlet {
	...
	@Override
	public void init(ServletConfig config) throws ServletException { //init()->HandlerMapper운용
		...
		try {
			...
			System.out.println("[DispatcherServlet] handlerMapper가 실패하였습니다.");
			e.printStackTrace();
		}
	}
	...
	private void requestPro(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		//commandHandler 실행(handlerMapper의뢰 action할당)
		Action action = null;
		String view = null;
