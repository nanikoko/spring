...
public class FileUploadController {
	...
	public ModelAndView uploadByMultipartFile(String title,
											  MultipartFile file,
											  ModelAndView mnv) throws Exception { //비동기(summernote)
		/* 파일저장폴더설정 */
		...
		mnv.setViewName("fileUploaded"); //jsp
	...
	public ModelAndView uploadByCommandObject(FileUploadCommand command, ModelAndView mnv) throws Exception { //동기(회원가입)
