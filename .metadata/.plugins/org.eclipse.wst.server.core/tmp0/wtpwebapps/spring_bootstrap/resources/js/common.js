...
//사용자 사진 출력
function MemberPictureTumb(contextPath){
	...
	target.summernote({
		...
		callbacks:{ //도구입력(event)받음
			onImageUpload : function(files, editor, welEditable) {
				...
				for (var file of files) {
					sendFile(file,this); //target->#content(textarea)
				}
			},
...
function sendFile(file, el) { //이미지파일을 선택해서 업로드한 다음 다시 다운로드해서 이미지를 넣어줌
