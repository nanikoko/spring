...
import kr.or.ddit.controller.rest.GetAttachesByMultipartFileAdatpter;
...
public class PdsController {
	...
	public String regist(PdsRegistCommand registReq,HttpServletRequest request,RedirectAttributes rttr) throws Exception {
		...
		List<AttachVO> attachList = GetAttachesByMultipartFileAdatpter.save(registReq.getUploadFile(), savePath);
	...
	public String modifyPOST(PdsModifyCommand modifyReq,  HttpServletRequest request, RedirectAttributes rttr) throws Exception {
		...
		// 파일 저장
		List<AttachVO> attachList = GetAttachesByMultipartFileAdatpter.save(modifyReq.getUploadFile(),fileUploadPath);
