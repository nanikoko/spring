...
public class NoticeController {
	...
	public ModelAndView detail(int nno, @RequestParam(defaultValue="") String from, HttpServletRequest reqeust, ModelAndView mnv) throws SQLException{
	...
	public String modify(NoticeVO notice, HttpSession session, HttpServletRequest request,RedirectAttributes rttr) throws Exception{
