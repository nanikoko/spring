...
public class SummernoteController {
	...
	public ResponseEntity<String> uploadImg(MultipartFile file, HttpServletRequest reqeust)throws IOException{
		...
		try {
			...
			result = new ResponseEntity<String>(reqeust.getContextPath()+"/getImg.do?fileName="+fileName, HttpStatus.OK);
		}catch(IOException e) {
			e.printStackTrace();
	...
	public ResponseEntity<String> deleteImg(@RequestBody Map<String, String> data){ //json데이터를 받기위해
		ResponseEntity<String> result = null;
		String savePath = imgPath.replace("/", File.separator);
